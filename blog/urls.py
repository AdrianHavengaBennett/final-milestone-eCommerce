...
urlpatterns = [
    ...
    path('new-product-post/<int:id>',
         new_product_post, name='new-product-post'),
    path('new-show-post/<int:id>', new_show_post, name='new-show-post'),
    path('post-detail/<int:id>', get_post_detail, name='post-detail'),
    path('edit-post/<int:id>', edit_post, name='edit-post'),
    path('delete-request/<int:id>',
         delete_post_request, name='delete-request'),
