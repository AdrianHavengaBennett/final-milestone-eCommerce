...
class Order(models.Model):
    ...
    tickets_total = models.DecimalField(
        max_digits=6, decimal_places=2, null=True, default=0)
    ...
    def update_total(self):
        ...
        self.delivery_cost = settings.STANDARD_DELIVERY_CHARGE\
            if self.delivery_option == 'deliver' else 0
...
class OrderLineProductItem(models.Model):
    order = models.ForeignKey(
        ...
        on_delete=models.CASCADE, related_name='productlineitems'
    )
    product = models.ForeignKey(
        Product, null=False, blank=False, on_delete=models.CASCADE)
    quantity = models.IntegerField(null=False, blank=False, default=0)
    productlineitems_total = models.DecimalField(
...
class OrderLineTicketItem(models.Model):
    order = models.ForeignKey(
        Order, null=False, blank=False,
        on_delete=models.CASCADE, related_name='ticketlineitems'
    )
    ticket = models.ForeignKey(
        ShowsTickets, null=False, blank=False,
        on_delete=models.CASCADE
    )
    quantity = models.IntegerField(null=False, blank=False, default=0)
    ticketlineitems_total = models.DecimalField(
