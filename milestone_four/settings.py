"""
Django settings for milestone_four project.
...
ALLOWED_HOSTS = ['music-n-more.herokuapp.com', 'localhost']
...
INSTALLED_APPS = [
    ...
    'click_and_collect.apps.ClickAndCollectConfig',
...
DEFAULT_FROM_EMAIL = 'contact-us@mnm.co.uk'
